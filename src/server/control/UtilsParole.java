...
public class UtilsParole {
	 ...
	 * 
	 * @param string
	 *            la stringa sulla quale calcolare le consonanti.
	 ...
	 * 
	 * @param string
	 *            la stringa sulla quale prelevare le consonanti.
	 * @param numero
	 *            il numero di consonanti da prelevare.
	 ...
	 * 
	 * @param string
	 *            la stringa sulla quale cercare.
	 * @param i
	 *            l'indice della consonante.
	 ...
	 * 
	 * @param string
	 *            la stringa sulla quale prelevare le vocali.
	 * @param numero
	 *            il numero di vocali da prelevare.
	 ...
	 * 
	 * @param string
	 *            la stringa sulla quale eliminare gli spazi bianchi.
	 ...
	 * @param character
	 *            il carattere.
	 * @return Restituisce true se il carattere è una vocale e false in caso
	 *         contrario.
	 */
	 ...
	 * 
	 * @param string
	 *            la stringa dal quale calcolare la stringa con tutti i caratteri di
	 *            posizione pari.
	 * @return Restituisce la stringa con tutti i caratteri di posizione pari di
	 *         string.
	 */
	 ...
	 *            la stringa dal quale calcolare la stringa con tutti i caratteri di
	 *            posizione dispari.
	 * @return Restituisce la stringa con tutti i caratteri di posizione dispari di
	 *         string.
	 */
